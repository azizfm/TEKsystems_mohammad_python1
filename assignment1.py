...
print("Hi, my name and age is " + first_name + " " + last_name + " " + str(my_age))

# use % operator to concatenate
# print("Hi, my name and age is %s %s" % (first_name, last_name))
print("Hi, my name and age is %s %s %s" % (first_name, last_name, my_age))

# using join() to concatenate
# print("Hi, my name and age is " + " ".join([first_name, last_name]))
print("Hi, my name and age is {0}".format(" ".join([first_name, last_name, str(my_age)])))
...
print('------print even numbers other method----------')
# for loops print even numbers from 1 - 10;
...
print('---------printing list of different types----------')
...
mylist = [1, 2, 'sample', True]
for inside in mylist:
    print(inside)

print('--------printing data type for each array item---------')
...
print("-----Printing Reverse String 'hello'")
x = 'hello'
print(x)
print(x[::-1])

# TODO: Reverse a number: input = 1234, output = 4321
print("-------Reverse a Number 1234 to 4321------")
y = 1234
as_string = str(y)
reversed_string = int(as_string[::-1])
print(y)
print(reversed_string)
print(type(reversed_string))

# ------other method to reverse
z: list[int] = [1, 2, 3, 4]
print(z)
z.reverse()
reversed_list = z
...
print("----------new_list to update in dessert list-----------")
for i, j in zip(my_list, dessert):
    print(i, j)
...
num_list = [1, 3, 4, 56, 78, ]
States = ['Washington', 'California', 'Oregon']
cities = ['seattle', 'Newyork', 'Dalla']
Appartment = ['unit1', 'unit2', 'unit3']
chores = ['Laundry', 'pick-up mail', 'clean the apt']
...
my_phones = {'iphone': 'Apple', 'samsung': 'android'}
cars = {'Toyota': 'camry', 'Honda': 'Civic', 'Ford': 'Escort'}

print('-----printing some values from the dictionary------')
m = my_dict
print('The value of key1 is: ', m['key1'])

n = friends
print("Ali's phone number is", n['ali'])

o = price_lookup
print('Price for the milk is:', o['milk'])

p = my_phones
print('my phone brand is ', p['iphone'])

q = cars
print('I like Honda ', q['Honda'])
